...
public class ProxyCacheReceta implements RecetaService, publisherSubscriber.Observer{
    ...
    public ProxyCacheReceta(PublisherPrx server){
    ...
    public void update(Current current) {
        publisherImp.notifySubscribers(current);
