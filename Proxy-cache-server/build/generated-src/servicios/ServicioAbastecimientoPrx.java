...
public interface ServicioAbastecimientoPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void notifyAlarmRecived(String mensaje, int codMaquina, String idAlarma)
    {
        notifyAlarmRecived(mensaje, codMaquina, idAlarma, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void notifyAlarmRecived(String mensaje, int codMaquina, String idAlarma, java.util.Map<String, String> context)
    {
        _iceI_notifyAlarmRecivedAsync(mensaje, codMaquina, idAlarma, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> notifyAlarmRecivedAsync(String mensaje, int codMaquina, String idAlarma)
    {
        return _iceI_notifyAlarmRecivedAsync(mensaje, codMaquina, idAlarma, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> notifyAlarmRecivedAsync(String mensaje, int codMaquina, String idAlarma, java.util.Map<String, String> context)
    {
        return _iceI_notifyAlarmRecivedAsync(mensaje, codMaquina, idAlarma, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_notifyAlarmRecivedAsync(String iceP_mensaje, int iceP_codMaquina, String iceP_idAlarma, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "notifyAlarmRecived", null, sync, null);
        f.invoke(false, context, null, ostr -> {
