...
{
    void recibirNotificacionEscasezIngredientes(ServicioAbastecimientoPrx serverProxy, String iDing, int idMaq, String idAlarma, com.zeroc.Ice.Current current);

    void recibirNotificacionInsuficienciaMoneda(ServicioAbastecimientoPrx serverProxy, Moneda moneda, int idMaq, String idAlarma, com.zeroc.Ice.Current current);

    void recibirNotificacionEscasezSuministro(ServicioAbastecimientoPrx serverProxy, String idSumin, int idMaq, String idAlarma, com.zeroc.Ice.Current current);

    void recibirNotificacionAbastesimiento(ServicioAbastecimientoPrx serverProxy, int idMaq, String idInsumo, int cantidad, String idAlarma, com.zeroc.Ice.Current current);

    void recibirNotificacionMalFuncionamiento(ServicioAbastecimientoPrx serverProxy, int idMaq, String descri, String idAlarma, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionEscasezIngredientes(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        ServicioAbastecimientoPrx iceP_serverProxy;
        String iceP_iDing;
        int iceP_idMaq;
        String iceP_idAlarma;
        iceP_serverProxy = ServicioAbastecimientoPrx.uncheckedCast(istr.readProxy());
        iceP_iDing = istr.readString();
        iceP_idMaq = istr.readInt();
        iceP_idAlarma = istr.readString();
        inS.endReadParams();
        obj.recibirNotificacionEscasezIngredientes(iceP_serverProxy, iceP_iDing, iceP_idMaq, iceP_idAlarma, current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionInsuficienciaMoneda(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_idAlarma = istr.readString();
        inS.endReadParams();
        obj.recibirNotificacionInsuficienciaMoneda(iceP_serverProxy, iceP_moneda, iceP_idMaq, iceP_idAlarma, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionEscasezSuministro(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_idAlarma = istr.readString();
        inS.endReadParams();
        obj.recibirNotificacionEscasezSuministro(iceP_serverProxy, iceP_idSumin, iceP_idMaq, iceP_idAlarma, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionAbastesimiento(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_idAlarma = istr.readString();
        inS.endReadParams();
        obj.recibirNotificacionAbastesimiento(iceP_serverProxy, iceP_idMaq, iceP_idInsumo, iceP_cantidad, iceP_idAlarma, current);
        return inS.setResult(inS.writeEmptyParams());
    }
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_recibirNotificacionMalFuncionamiento(AlarmaService obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        iceP_idAlarma = istr.readString();
        inS.endReadParams();
        obj.recibirNotificacionMalFuncionamiento(iceP_serverProxy, iceP_idMaq, iceP_descri, iceP_idAlarma, current);
        return inS.setResult(inS.writeEmptyParams());
    }
