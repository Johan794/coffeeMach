...
public interface ServicioAbastecimiento extends com.zeroc.Ice.Object
{
    ...
    void notifyAlarmRecived(String mensaje, int codMaquina, String idAlarma, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_notifyAlarmRecived(ServicioAbastecimiento obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_mensaje;
        ...
        inS.endReadParams();
        obj.notifyAlarmRecived(iceP_mensaje, iceP_codMaquina, iceP_idAlarma, current);
        return inS.setResult(inS.writeEmptyParams());
    }
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 5:
            {
                return _iceD_notifyAlarmRecived(this, in, current);
            }
        }
