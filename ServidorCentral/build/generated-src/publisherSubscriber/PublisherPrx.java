...
// <auto-generated>
//
// Generated from file `PublisherSubscriber.ice'
//
...
{
    default void addSubscriber(ObserverPrx observer, String hostname)
    {
        addSubscriber(observer, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addSubscriber(ObserverPrx observer, String hostname, java.util.Map<String, String> context)
    {
        _iceI_addSubscriberAsync(observer, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> addSubscriberAsync(ObserverPrx observer, String hostname)
    {
        return _iceI_addSubscriberAsync(observer, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addSubscriberAsync(ObserverPrx observer, String hostname, java.util.Map<String, String> context)
    {
        return _iceI_addSubscriberAsync(observer, hostname, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addSubscriberAsync(ObserverPrx iceP_observer, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "addSubscriber", null, sync, null);
    ...
    default void removeSubscriber(ObserverPrx observer, String hostname)
    {
        removeSubscriber(observer, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void removeSubscriber(ObserverPrx observer, String hostname, java.util.Map<String, String> context)
    {
        _iceI_removeSubscriberAsync(observer, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> removeSubscriberAsync(ObserverPrx observer, String hostname)
    {
        return _iceI_removeSubscriberAsync(observer, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> removeSubscriberAsync(ObserverPrx observer, String hostname, java.util.Map<String, String> context)
    {
        return _iceI_removeSubscriberAsync(observer, hostname, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_removeSubscriberAsync(ObserverPrx iceP_observer, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
    ...
    {
        notifySubscribers(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void notifySubscribers(java.util.Map<String, String> context)
    {
        _iceI_notifySubscribersAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> notifySubscribersAsync()
    {
        return _iceI_notifySubscribersAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> notifySubscribersAsync(java.util.Map<String, String> context)
    {
        return _iceI_notifySubscribersAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_notifySubscribersAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "notifySubscribers", null, sync, null);
    ...
    {
        return "::publisherSubscriber::Publisher";
    }
}
